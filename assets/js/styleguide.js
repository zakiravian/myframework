...
$(document).ready(function(){
    ...
    aramco.fitBackgroundForCards();

    // Init icon search action for the navbar
    aramco.initNavbarSearch();

    // Init popovers
    aramco.initPopovers();

    // Init Collapse Areas
    aramco.initCollapseArea();

    // Init Sliders
    aramco.initSliders();

    //  Init video card actions
    aramco.initVideoCards();
...
$(window).resize(function(){
    if($(window).width() < 768){
        aramco.initRightMenu();
    } else if(!burger_menu && aramco.misc.navbar_menu_visible){
        aramco.toggleSidebarMenu();
    }
});
...
aramco = {
    ...
    initRightMenu: function(){
         if(!navbar_initialized){
            ...
            $toggle.click(aramco.toggleSidebarMenu);
    ...
    toggleSidebarMenu: function(){
        if(aramco.misc.navbar_menu_visible == 1) {
            $('html').removeClass('nav-open');
            aramco.misc.navbar_menu_visible = 0;
            $('.body-click').remove();
             setTimeout(function(){
            ...
            aramco.misc.navbar_menu_visible = 1;
        }
    },
    ...
    initCollapseArea: function(){
        $('[data-toggle="pnl-collapse"]').each(function () {
            var thisdiv = $(this).attr("data-target");
            $(thisdiv).addClass("p-collapse");
        });

        $('[data-toggle="pnl-collapse"]').hover(function(){
            var thisdiv = $(this).attr("data-target");
